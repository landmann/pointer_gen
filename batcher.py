...
## Keep most prononuns
stopwords_to_keep = {'i','me','myself',
                     'you','yourself','yours','yourselves',
                     'her','herself', 'hers',
                     'him','himself', 'his'
                     'our','ourselves','ours',
                     'they','themseles','their','theirs'}

stopwords -= stopwords_to_keep
      ...
      for i, sent in enumerate(sentences):
        ...
        for word in sent.split(' '):
          ...
          if hps.keep_stopwords < 1.0:
            if (word.lower() in stopwords) and (random.random() > hps.keep_stopwords):
              continue
